...
class FavoritesTable extends Table {
	 ...
	 */
	public function add(string $model, string|int $foreignKey, int $userId, ?int $value = null): Favorite {
		$data = [
			'model' => $model,
	 ...
	 * @return int
	 */
	public function remove(string $model, string|int $foreignKey, int $userId): int {
		$data = [
			'model' => $model,
			'foreign_key' => $foreignKey,
			'user_id' => $userId,
